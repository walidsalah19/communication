...
public class ChatDetialsTeacherFragment extends Fragment {
    ...
    public static ChatDetialsTeacherFragment createFor() {
        ChatDetialsTeacherFragment fragment = new ChatDetialsTeacherFragment();
        ...
        database.child("group_chat").child(chat_id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists())
                {
                    ...
                    chat_recycler_adapter adapter=new chat_recycler_adapter(message_arr, ChatDetialsTeacherFragment.this,user_id);
